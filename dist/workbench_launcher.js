...
exports.WorkbenchLauncher = void 0;
class WorkbenchLauncher {
    ...
    async launch() {
        ...
        try {
            ...
            const menuFound = await this.browser.click('button:has(svg[data-testid="MoreVertIcon"])||button svg[data-testid="MoreVertIcon"]', 1000);
            if (menuFound) {
                ...
                const workbenchClicked = await this.browser.click('li button span:has-text("Launch Workbench")||li button:has-text("Launch Workbench")||span:has-text("Launch Workbench")', 1000);
                if (workbenchClicked) {
            ...
            const directLaunch = await this.browser.click('button:has-text("Launch")||a:has-text("Launch")', 1500);
            if (directLaunch) {
                await this.browser.waitForNavigation(5000);
                await this.browser.waitForTimeout(300);
                const duration = Date.now() - startTime;
...
exports.WorkbenchLauncher = WorkbenchLauncher;
//# sourceMappingURL=workbench_launcher.js.map