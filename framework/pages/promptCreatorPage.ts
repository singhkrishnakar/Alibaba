...
/**
 * FormFields encapsulates all shared field locators scoped to a container.
 * Both PromptCreatorPage (main page) and ReviewAndSubmitForm (modal) use this.
 * 
 * This is the Playwright equivalent of a PageComponent in enterprise Selenium frameworks.
 * Instead of extending a base page, we pass a root locator and scope all selectors to it.
 * 
 * DevTools verify root for modal: document.querySelector('.sc-2e6de984-4')
 * DevTools verify root for main page: document.querySelector('form, main, body')
 */
// export class FormFields {
//     constructor(private root: Locator, private page: Page) {}

//     // ─────────────────────────────────────────
//     // LOCATORS — all scoped to root container
//     // ─────────────────────────────────────────

//     /**
//      * Prompt textarea — works for both MC and Essay.
//      * DevTools: document.querySelector('div.question-textarea textarea')
//      */
//     get promptTextarea() {
...
//      * DevTools: document.querySelector('textarea[placeholder*="Let\'s say the length"]')
//      */
//     get finalAnswerTextarea() {
...
//     /**
//      * Solution Process textarea — first one inside solution-process-textarea wrapper.
//      * DevTools: document.querySelectorAll('div.solution-process-textarea textarea')[0]
//      */
//     get solutionProcessTextarea() {
...
//     /**
//      * Thinking Process textarea — second one inside solution-process-textarea wrapper.
//      * DevTools: document.querySelectorAll('div.solution-process-textarea textarea')[1]
//      */
//     get thinkingProcessTextarea() {
//         return this.root.locator('div.solution-process-textarea textarea').nth(1);
//     }

//     /**
//      * Answer Unit textarea.
//      * DevTools: document.querySelector('div.unitsForAnswerTextareaWrapper textarea')
//      */
//     get answerUnitTextarea() {
...
//     /**
//      * No unit checkbox label — click label, not the hidden input.
//      * DevTools: document.querySelector('span.sc-c89fac35-5')
//      */
//     get noUnitLabel() {
//         return this.root.locator('span.sc-c89fac35-5').filter({ hasText: 'This answer does not require a unit' });
//     }

//     /**
//      * Level React Select input — stable ID from HTML.
//      * DevTools: document.querySelector('#react-select-dropdown-level-dropdown-input')
//      */
//     get levelDropdownInput() {
...
//     /**
//      * Discipline React Select input — stable ID from HTML.
//      * DevTools: document.querySelector('#react-select-dropdown-disciplines-dropdown-input')
//      */
//     get disciplineDropdownInput() {
//         return this.root.locator('#react-select-dropdown-disciplines-dropdown-input');
//     }

//     /** React Select option — shared by both Level and Discipline dropdowns */
//     reactSelectOption(text: string) {
//         return this.page.getByRole('option', { name: text, exact: true });
//     }

//     /**
//      * Key Points clickable area.
//      * DevTools: document.querySelector('div.sc-c9e57cf2-1')
//      */
//     get keyPointsClickArea() {
...
//     get keyPointsAddButton() {
//         return this.root.locator('button:has(svg[data-testid="AddOutlinedIcon"]) span:has-text("Add")');
//     }
...
//     // ─────────────────────────────────────────
//     // ACTIONS — reusable by both pages
//     // ─────────────────────────────────────────
...
//         await this.keyPointsSaveButton.waitFor({ state: 'visible', timeout: 3000 });
//         await this.keyPointsSaveButton.click();
//         // Close dropdown by clicking the label area
